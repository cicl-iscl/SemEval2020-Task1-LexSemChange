...
if __name__ == '__main__':
    ...
    corpus_new = preprocess(
        '/home/pia/train_elmo/SemEval2020/starting_kit/trial_data_public/corpora/swedish/corpus2/corpus2.txt')
    joined_corpus = preprocess(
        '/home/pia/train_elmo/SemEval2020/starting_kit/trial_data_public/corpora/swedish/corpus1+2/corpus_SWE_combined.txt')

    target_words_SWE = ["sorn", "äro", "första", "blef"]

    results = dict()

    for word in target_words_SWE:
        print("\nSTARTING THE ANALYSIS FOR TARGET WORD: " + word + " ===============================================================")
        # args: embedding, language abbreviation, corpus path, individual target word
        labels1, set_labels1 = process_corpus(e_SWE, "SWE", "1",
                                '/home/pia/train_elmo/SemEval2020/starting_kit/trial_data_public/corpora/swedish/corpus1/corpus1.txt',
                                word)
        labels2, set_labels2 = process_corpus(e_SWE, "SWE", "2",
                              '/home/pia/train_elmo/SemEval2020/starting_kit/trial_data_public/corpora/swedish/corpus2/corpus2.txt',
                              word)
        labels_comb, set_labels_comb = process_corpus(e_SWE, "SWE", "combined",
               '/home/pia/train_elmo/SemEval2020/starting_kit/trial_data_public/corpora/swedish/corpus1+2/corpus_SWE_combined.txt',
                                 word)
    ...
    print("results for SWEDISH: ", results)
