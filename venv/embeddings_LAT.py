...
if __name__ == '__main__':
    ...
    e_LAT = Embedder('/home/pia/train_elmo/SemEval2020/162-latin-model', batch_size=64)

    corpus_old = preprocess(
        '/home/pia/train_elmo/SemEval2020/starting_kit/trial_data_public/corpora/latin/corpus1/corpus1.txt')
    corpus_new = preprocess(
        '/home/pia/train_elmo/SemEval2020/starting_kit/trial_data_public/corpora/latin/corpus2/corpus2.txt')
    joined_corpus = preprocess(
        '/home/pia/train_elmo/SemEval2020/starting_kit/trial_data_public/corpora/latin/corpus1+2/corpus_LAT_combined.txt')

    target_words_LAT = ["necessarius", "nepos", "pontifex", "virtus"]

    results = dict()

    for word in target_words_LAT:
        print("\nSTARTING THE ANALYSIS FOR TARGET WORD: " + word + " ===============================================================")
        # args: embedding, language abbreviation, corpus path, individual target word
        labels1, set_labels1 = process_corpus(e_LAT, "LAT", "1",
                                '/home/pia/train_elmo/SemEval2020/starting_kit/trial_data_public/corpora/latin/corpus1/corpus1.txt',
                                word)
        labels2, set_labels2 = process_corpus(e_LAT, "LAT", "2",
                              '/home/pia/train_elmo/SemEval2020/starting_kit/trial_data_public/corpora/latin/corpus2/corpus2.txt',
                              word)
        labels_comb, set_labels_comb = process_corpus(e_LAT, "LAT", "combined",
               '/home/pia/train_elmo/SemEval2020/starting_kit/trial_data_public/corpora/latin/corpus1+2/corpus_LAT_combined.txt',
                                 word)
    ...
    print("results for LATIN: ", results)
